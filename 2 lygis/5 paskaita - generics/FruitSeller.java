...
public class FruitSeller<T extends Fruit> {
	...
	public void moreFruitsSold(FruitSeller<T> opponent) {
		...
		if(fruitsSold > opponent.getFruitsSold()) {
			...
			System.out.println(opponent.getName() + " sold the same amount of fruits as " + name);
		}
